...
export default function Booking() {
  ...
  return (
    <div className="bg-[#FAF6F0] text-[#2C2621] min-h-screen pt-28 sm:pt-32 pb-24">
      
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header Title Section */}
        <div className="text-center space-y-3 mb-10">
          <span className="text-xs font-sans tracking-[0.35em] text-[#C6A66B] uppercase font-semibold">
            RESERVATIONS
          </span>
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-[#2C2621] uppercase font-light">
            Book Your <span className="italic text-gold-gradient font-normal">Spa Therapy</span>
          </h1>
          <p className="font-sans text-xs sm:text-sm text-[#4A423A] font-light max-w-xl mx-auto">
        ...
        <div className="mb-14 max-w-3xl mx-auto px-2">
          <div className="flex items-center justify-between relative">
            ...
            <div className="absolute left-0 right-0 top-4 h-[2px] bg-[#C6A66B]/25 -z-0"></div>
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-sans font-semibold transition-all duration-300 ${
                      isCompleted
                        ? 'bg-[#C6A66B] text-[#FAF6F0] shadow-sm'
                        : isCurrent
                        ? 'bg-[#C6A66B] text-[#FAF6F0] ring-4 ring-[#C6A66B]/30 font-bold shadow-gold-glow'
                        : 'bg-[#FFFDF9] text-[#2C2621] border border-[#C6A66B]/40 group-hover:border-[#C6A66B]'
                    }`}
                  >
                    {isCompleted ? <Check className="w-4 h-4 stroke-[3]" /> : step.number}
                  </div>
                  <span
                    className={`text-[10px] sm:text-[11px] font-sans tracking-widest uppercase mt-2 transition-colors ${
                      isCurrent
                        ? 'text-[#C6A66B] font-bold'
                        : isCompleted
                        ? 'text-[#2C2621] font-bold'
                        : 'text-[#4A423A] font-semibold'
                    }`}
                  >
                    {step.label}
                  </span>
        ...
        {currentStep === 1 && (
          <div className="max-w-2xl mx-auto bg-[#FFFDF9] border border-[#C6A66B]/30 rounded-lg p-6 sm:p-10 shadow-luxury space-y-6">
            <div className="space-y-1">
              <span className="text-[10px] font-sans tracking-wider text-[#C6A66B] uppercase font-semibold">
                SELECT SANCTUARY BRANCH
              </span>
              <h2 className="font-serif text-2xl text-[#2C2621] uppercase font-light">
                Choose Location
              </h2>
            </div>
            ...
            <div
              ...
              className="p-6 bg-[#F4EDE4] border-2 border-[#C6A66B] rounded-md flex items-start gap-4 cursor-pointer relative shadow-sm"
            >
              <div className="p-3 bg-[#C6A66B]/20 text-[#C6A66B] rounded-full shrink-0">
                <MapPin className="w-6 h-6" />
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <h3 className="font-serif text-lg text-[#2C2621] uppercase font-medium">
                ...
                <div className="text-xs text-[#C6A66B] font-sans font-semibold">
            ...
            <div className="pt-4 flex justify-end">
              <button
                ...
                className="px-8 py-3.5 bg-[#C6A66B] text-[#FAF6F0] text-xs font-sans uppercase tracking-widest font-semibold hover:bg-[#a8884c] transition-all flex items-center gap-2 rounded-sm shadow-gold-glow"
              >
        ...
        {currentStep === 2 && (
          <div className="bg-[#FFFDF9] border border-[#C6A66B]/30 rounded-xl p-6 sm:p-10 shadow-luxury space-y-8">
            
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#C6A66B]/20 pb-6">
              <div>
                <span className="text-[10px] font-sans tracking-wider text-[#C6A66B] uppercase font-semibold block mb-1">
                  STEP 2 OF 5
                </span>
                <h2 className="font-serif text-3xl sm:text-4xl text-[#2C2621]">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 text-xs font-sans tracking-wider uppercase rounded-full transition-all duration-300 whitespace-nowrap ${
                      activeCategory === cat.id
                        ...
                        : 'bg-[#F4EDE4] text-[#2C2621] hover:bg-[#C6A66B]/20 border border-[#C6A66B]/30 font-medium'
                    }`}
                  >
                    {cat.label}
                  </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {filteredServices.map((service) => {
                ...
                return (
                  <div
                    key={service.id}
                    className={`p-5 bg-[#F4EDE4] border rounded-lg transition-all duration-300 flex flex-col justify-between space-y-4 ${
                      isServiceSelected
                        ? 'border-2 border-[#C6A66B] shadow-gold-glow bg-[#F4EDE4]'
                        : 'border-[#C6A66B]/25 hover:border-[#C6A66B]/60'
                    }`}
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="space-y-1.5 flex-1">
                        <span className="text-[9px] font-sans tracking-widest text-[#C6A66B] uppercase font-semibold block">
                          {service.category}
                        </span>
                        <h3 className="font-serif text-lg sm:text-xl text-[#2C2621] font-light leading-snug">
                          {service.name}
                        </h3>
                        <p className="font-sans text-xs text-[#4A423A] font-normal leading-relaxed line-clamp-2">
                    ...
                    <div className="space-y-2 pt-2 border-t border-[#C6A66B]/20">
                      <span className="text-[10px] font-sans tracking-wider text-[#2C2621] uppercase block font-semibold">
                        ...
                        {service.pricing ? (
                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-2 text-xs font-sans rounded-md border transition-all text-center flex items-center justify-center gap-1.5 ${
                                  isOptionActive
                                    ? 'bg-[#C6A66B] text-[#FAF6F0] border-[#C6A66B] font-semibold shadow-gold-glow'
                                    : 'bg-[#FFFDF9] text-[#2C2621] border-[#C6A66B]/30 hover:border-[#C6A66B]'
                                }`}
                              >
                          ...
                          <button
                            ...
                            className={`col-span-2 px-3 py-2 text-xs font-sans rounded-md border transition-all text-center ${
                              isServiceSelected
                                ? 'bg-[#C6A66B] text-[#FAF6F0] border-[#C6A66B] font-semibold'
                                : 'bg-[#FFFDF9] text-[#2C2621] border-[#C6A66B]/30 hover:border-[#C6A66B]'
                            }`}
                          >
        ...
        {currentStep === 3 && (
          <div className="max-w-3xl mx-auto bg-[#FFFDF9] border border-[#C6A66B]/30 rounded-xl p-6 sm:p-10 shadow-luxury space-y-8">
            
            <div>
              <span className="text-[10px] font-sans tracking-wider text-[#C6A66B] uppercase font-semibold block mb-1">
                STEP 3 OF 5
              </span>
              <h2 className="font-serif text-3xl text-[#2C2621] uppercase">
            ...
            {selectedService && (
              <div className="p-4 bg-[#F4EDE4] border border-[#C6A66B]/30 rounded-md flex items-center justify-between">
                <div>
                  <span className="text-[10px] text-[#C6A66B] font-sans uppercase font-semibold block">Selected Therapy:</span>
                  <div className="font-serif text-lg text-[#2C2621]">{selectedService.name}</div>
                </div>
            ...
            <div className="space-y-2">
              <label className="block text-xs font-sans uppercase tracking-widest text-[#4A423A] font-semibold">
              ...
              <input
                ...
                className="w-full bg-[#FFFDF9] border border-[#C6A66B]/40 text-[#2C2621] text-sm p-4 rounded-md focus:outline-none focus:border-[#C6A66B]"
              />
            </div>
                  ...
                  return (
                    <button
                      ...
                      className={`p-3 text-xs font-sans rounded-md border text-center transition-all ${
                        isSlotActive
                          ? 'bg-[#C6A66B] text-[#FAF6F0] border-[#C6A66B] font-semibold shadow-gold-glow'
                          : 'bg-[#F4EDE4] text-[#2C2621] border-[#C6A66B]/30 hover:border-[#C6A66B]'
                      }`}
                    >
                      {slot}
                    </button>
            ...
            {/* Step Navigation Buttons */}
            <div className="pt-6 border-t border-[#C6A66B]/20 flex items-center justify-between">
              <button
                onClick={() => setCurrentStep(2)}
                className="px-6 py-3 border border-[#C6A66B]/40 text-[#4A423A] text-xs font-sans uppercase tracking-widest hover:text-[#C6A66B] rounded-sm flex items-center gap-2"
              >
                <ChevronLeft className="w-4 h-4" />
              ...
              <button
                ...
                className="px-8 py-3.5 bg-[#C6A66B] text-[#FAF6F0] text-xs font-sans uppercase tracking-widest font-semibold hover:bg-[#a8884c] rounded-sm flex items-center gap-2 shadow-gold-glow"
              >
        ...
        {currentStep === 4 && (
          <div className="max-w-2xl mx-auto bg-[#FFFDF9] border border-[#C6A66B]/30 rounded-xl p-6 sm:p-10 shadow-luxury space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-sans uppercase tracking-widest text-[#4A423A] mb-2 font-medium">
                    Full Name *
                  </label>
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      className="w-full bg-[#FFFDF9] border border-[#C6A66B]/40 text-[#2C2621] text-sm py-3.5 px-4 pl-11 rounded-md focus:outline-none focus:border-[#C6A66B]"
                    />
                  </div>
                </div>
        ...
        {currentStep === 5 && (
          <div className="max-w-2xl mx-auto bg-[#FFFDF9] border border-[#C6A66B]/40 rounded-xl p-6 sm:p-10 shadow-luxury space-y-8">
            ...
            {/* Summary Card */}
            <div className="p-6 bg-[#F4EDE4] border border-[#C6A66B]/30 rounded-lg space-y-4 font-sans text-xs">
              
              <div className="flex items-center justify-between pb-3 border-b border-[#C6A66B]/20">
                <span className="text-[#786C60]">Sanctuary Branch:</span>
                <span className="text-[#2C2621] font-semibold">{selectedBranch}</span>
              </div>

              <div className="flex items-center justify-between pb-3 border-b border-[#C6A66B]/20">
                <span className="text-[#786C60]">Treatment Chosen:</span>
                <span className="text-[#C6A66B] font-semibold text-sm">{selectedService?.name}</span>
              </div>

              <div className="flex items-center justify-between pb-3 border-b border-[#C6A66B]/20">
                <span className="text-[#786C60]">Duration & Price:</span>
                <span className="text-[#2C2621] font-semibold">{selectedOption?.duration} • {selectedOption?.price}</span>
              </div>

              <div className="flex items-center justify-between pb-3 border-b border-[#C6A66B]/20">
                <span className="text-[#786C60]">Date & Time:</span>
                <span className="text-[#2C2621] font-semibold">{date} at {timeSlot}</span>
              </div>

              <div className="flex items-center justify-between pb-3 border-b border-[#C6A66B]/20">
                <span className="text-[#786C60]">Guest Name:</span>
                <span className="text-[#2C2621] font-semibold">{guestDetails.name}</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-[#786C60]">WhatsApp Phone:</span>
                <span className="text-[#2C2621] font-semibold">{guestDetails.phone}</span>
              </div>

              {guestDetails.notes && (
                <div className="pt-2 text-[11px] text-[#786C60] border-t border-[#C6A66B]/20">
                  <span className="text-[#C6A66B] font-semibold">Notes:</span> {guestDetails.notes}
                </div>
              )}
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-4 bg-[#25D366] text-[#FAF6F0] text-xs font-sans uppercase tracking-widest font-semibold hover:bg-[#20ba5a] transition-all duration-300 shadow-luxury flex items-center justify-center gap-3 rounded-md"
              >
                <MessageCircle className="w-5 h-5 fill-current" />
                <span>CONFIRM & SEND ENQUIRY ON WHATSAPP</span>
              </button>

              <div className="flex items-center justify-center gap-2 text-[11px] text-[#786C60] font-sans font-medium">
            ...
            <div className="pt-2 text-center">
              <button
                onClick={() => setCurrentStep(4)}
                className="text-xs font-sans text-[#786C60] hover:text-[#C6A66B] underline transition-colors"
              >
                ← Edit Guest Details
              </button>
            </div>
